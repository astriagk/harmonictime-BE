...
export const accountBlockedEmail = (): EmailTemplate => ({
  subject: `Your ${env.BRAND_NAME} account has been blocked`,
  ...
  html: layout(`
    ...
    <p style="margin:0 0 12px;">Your ${env.BRAND_NAME} account has been <strong>blocked</strong> by our team.</p>
...
export const accountSuspendedEmail = (): EmailTemplate => ({
  subject: `Your ${env.BRAND_NAME} account has been suspended`,
  ...
  html: layout(`
    ...
    <p style="margin:0 0 12px;">Your ${env.BRAND_NAME} account has been <strong>temporarily suspended</strong>.</p>
...
export const accountRestoredEmail = (): EmailTemplate => ({
  subject: `Your ${env.BRAND_NAME} account has been restored`,
  text: `Good news — your ${env.BRAND_NAME} account has been restored and you can log in again. Welcome back!`,
  html: layout(`
    <h2 style="margin:0 0 16px;color:#16a34a;">Account Restored</h2>
    <p style="margin:0 0 12px;">Good news! Your ${env.BRAND_NAME} account has been <strong>restored</strong> and is now active.</p>
